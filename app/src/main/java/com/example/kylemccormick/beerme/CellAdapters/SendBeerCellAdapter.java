 ...
 */
public class SendBeerCellAdapter extends BaseAdapter implements Filterable {
    private Context mContext;
    private ArrayList<String> mFriends;
    private ArrayList<String> mmFriends;

    public SendBeerCellAdapter(Context context, ArrayList<String> friends){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.sendbeer_custom_cell, null);
