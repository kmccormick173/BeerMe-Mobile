...
public class Send_Beer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new SendBeerCellAdapter(this,friends);
    ...
    public void startRequest() {
        ...
        builder
                .setTitle("Would you like to send a beer?")
                .setMessage("You will be charged $5 upon photo approval!")
                .setIcon(android.R.drawable.ic_dialog_alert)
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        //Yes button clicked, do something
                        Toast.makeText(Send_Beer.this, "Do Transaction",
